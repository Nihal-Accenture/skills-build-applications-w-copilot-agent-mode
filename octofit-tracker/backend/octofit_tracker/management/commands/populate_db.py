...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Activities
        Activity.objects.create(user='Iron Man', type='Running', duration=30, date='2026-02-25')
        Activity.objects.create(user='Captain America', type='Cycling', duration=45, date='2026-02-25')
        Activity.objects.create(user='Batman', type='Swimming', duration=60, date='2026-02-25')
        Activity.objects.create(user='Superman', type='Flying', duration=120, date='2026-02-25')
        ...
        # Workouts
        Workout.objects.create(name='Hero HIIT', description='High intensity workout for superheroes', suggested_for='Marvel')
